...
import com.ssafy.finale.exception.UnAuthorizedException;
...
public class JwtServiceImpl implements JwtService {
	...
	private static final int ACCESS_TOKEN_EXPIRE_MINUTES = 1000; // 분단위
	private static final int REFRESH_TOKEN_EXPIRE_MINUTES = 500; // 주단위
